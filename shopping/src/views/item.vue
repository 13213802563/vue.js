			...
			<div class="item-box">
				...
				<div class="gallery-wrapper">
					<div class="gallery">
						...
						<div class="thumb">
							<ul>
								<!--<li :class="{'cur':color.id==$query.itemId}" key="index" v-for="img,index in itemsInfo.ali_images"><img :src="img+'?x-oss-process=image/resize,w_440/quality,Q_90/format,webp'"></li>-->
...
<script>
	...
	export default {
		...
		methods: {
		    ...
		    //得到添加的数量   在这个页面可以添加多个    this.count得到数量
			addCarPanelHandle() {
