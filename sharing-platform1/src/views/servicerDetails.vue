<template>
    <div>
        ...
        <div class="g-list">
            ...
            <div class="item" v-if="this.$route.query.type!=1 && this.$route.query.type!='4'">
...
<!--            </div>-->
        ...
        <div class="g-pics">
            ...
            <template v-for="value in picList" v-if="typeOrder == 4">
                <p v-if="value.type>2 &&typeOrder == 4" style="margin-top: 0.5rem">{{checkImgType(value.type)}}</p>
                <img v-if="value.type>2&&typeOrder == 4" :src="value.url" alt="">
            </template>
            <template v-for="value in picList"  v-if="typeOrder != 4">
    ...
    export default {
        ...
        data(){
            return {
                ...
                picList:[],
                name: '',
                typeOrder:this.$route.query.type
            }
        },
        ...
        mounted() {
            ...
            //})
            if(that.$route.query.type=='1' || that.$route.query.type=='4'){
                console.log('公海池详情')
        ...
        methods:{
            ...
            back () {
                ...
                else if(this.$route.query.orderType=='order'){
                    this.$router.push('/index/orderManagerment/promotedServicePersonnel?orderType=order');
                }else if(this.$route.query.type=='contract'){
                    this.$router.push({
                ...
                else if(this.$route.query.status=='finish'){
                    this.$router.push({
                        name:'orderManagerment',
                        query:{
                            val:2
                ...
                else if(this.$route.query.status=='contractConfirm'){
                    this.$router.push({
                        name:'orderManagerment',
                        query:{
                            val:1,
                ...
                else if(this.$route.query.status=='awaitingPay'){
                    this.$router.push({
                        name:'orderManagerment',
                        query:{
                            val:1,
        ...
        computed:{
            entry(){
                if(this.$route.query.type =='4'||this.$route.query.type=='1' ){
                    return [this.$route.query.type!='1' ||this.$route.query.type =='4' ,'管家手机']
                }else{
