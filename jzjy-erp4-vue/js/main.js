var path='http://t.erp.95081.com/apidisp/to/dispatcher';

//url地址
	function posturl(){
		//return "http://shibo.95081.com:8080/amib";
		//return "http://wyx.95081.com:8081/amib";
		//return "/amib/";
		return "http://amib.95081.com/amib"
	}
    	...
    	*/
		function openModule(url,org,func,option,id){
			...
			/**
			 * 使org传递的参数可以被接收 fixbug 高长浩 2019年4月2日 19:43:01
			 */
			return org;
		}
...
//分页
function queryAuditListBody(num,count) {
 	if (null == num || "" == num || isNaN(parseInt(num))) {
 		alert("请输入数字");
  		return;
 	}
 	auditList(num,(count?count:15));
}
function judgeUndefined(val){
